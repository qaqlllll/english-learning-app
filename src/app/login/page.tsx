        ...
        <CardContent>
          <form className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4 pt-4">
              <SubmitButton formAction={login} variant="default" pendingText="Logging in...">Log in</SubmitButton>
              <SubmitButton formAction={signup} variant="outline" pendingText="Signing up...">Sign up</SubmitButton>
            </div>
          </form>
          ...
          <form action={signInWithGoogle}>
            <SubmitButton variant="outline" className="w-full" type="submit" pendingText="Redirecting...">
